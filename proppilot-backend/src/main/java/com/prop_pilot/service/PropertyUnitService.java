...
public interface PropertyUnitService {
    ...
    List<PropertyUnit> getPropertyUnitsByTenant(Long tenantId, @NonNull Long ownerId);
    PropertyUnit updatePropertyUnit(@NonNull Long id, PropertyUnit propertyUnit, @NonNull Long ownerId);
